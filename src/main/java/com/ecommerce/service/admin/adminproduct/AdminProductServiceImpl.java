...
public class AdminProductServiceImpl implements AdminProductService {
    ...
    public Product addProduct(SecondProductDto secondProductDto) throws IOException {
        ...
        product.setDuoPrice(secondProductDto.getDuoPrice());
        product.setFamilyPrice(secondProductDto.getFamilyPrice());
    ...
    public List<ProductDto> getAllProducts() {
        ...
        return products.stream().map(product -> {
            ...
            productDto.setDuoPrice(product.getDuoPrice());
            productDto.setFamilyPrice(product.getFamilyPrice());
            return productDto;
    ...
    public ProductDto updateProduct(Long productId, ProductDto productDto) throws IOException {
        ...
        if (optionalProduct.isPresent() && category.isPresent()) {
            ...
            product.setDuoPrice(productDto.getDuoPrice());
            product.setFamilyPrice(productDto.getFamilyPrice());
