    ...
    public ResponseEntity<?> addProductToCart(CartItemsDto cartItemsDto) {
        ...
        if (cartItem.isPresent()) {
            ...
            if (optionalProduct.isPresent() && optionalUser.isPresent()) {
                ...
                if(Objects.equals(cartItemsDto.getPlan(), "familyPrice")){
                    cart.setPrice(product.getFamilyPrice());
                } else if(Objects.equals(cartItemsDto.getPlan(), "duoPrice")){
                    cart.setPrice(product.getDuoPrice());
                }else{
